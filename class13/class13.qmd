...
```{r}
x <- c(chandra=10, alive=9, barry=7)
...
Let's have a look at the hsa05310 Asthama pathway with our genes highlighted using the `pathview()` function:
