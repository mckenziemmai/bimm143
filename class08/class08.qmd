...
>Q. How many observations/patients/individuals/samples are in this dataset?
...
To get my clustering result/membership vector I need to "cut" the tree witht he `cutree` function.
...
Principal Component Analysis (PCA) is a super useful method for analyzing large datasets. It works by finding new varibales (PCs) that capture the most variance from the original variables in your dataset.
